...
function AddFunds() {
  ...
  return (
    <div id="addFund" className="w-full mx-auto text-black">
      <header className="pb-3">
        <h1 className="text-2xl md:text-4xl font-bold">Add Funds</h1>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-10">
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-blue-600 cursor-pointer text-white font-bold py-4 px-4 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-offset-2 focus:ring-blue-600 transition-all duration-300"
              >
