import { DollarSign, Home, Puzzle, UserCircle2Icon } from "lucide-react";
...
function MainLayout() {
  ...
  return (
    <div className="h-screen mx-4 text-black flex">
      <div className="border-r w-48 pr-4 py-6 space-y-4">
        ...
        <button
          ...
          className={`w-full gap-1 flex items-center text-left px-2 py-2 rounded ${
            activeTab === "funds" ? "bg-blue-500 text-white" : "hover:bg-gray-200"
          }`}
        >
        ...
        <button
          ...
          className={`w-full gap-1 flex items-center text-left px-2 py-2 rounded ${
            activeTab === "task" ? "bg-blue-500 text-white" : "hover:bg-gray-200"
          }`}
        >
